...
const Register = ({ handleChange, handleRegisterSubmit, formData }) => {
  ...
  return (
    <form onSubmit={handleRegisterSubmit} className='p-4 md:w-1/4 w-1/2 flex flex-col gap-4'>
      ...
      <input name='password' value={formData.password} onChange={(e)=>handleChange(e)} placeholder='password' className='p-2 outline-none rounded border border-zinc-500 bg-zinc-300' type="text" />
